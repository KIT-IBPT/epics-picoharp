{
  PicoHarp 300  PHLIB v2.2  Usage Demo with Kylix
  tested with Kylix 3.0 Professional on Suse Linux 9.1
  ...
  Matthias Patting, Michael Wahl, PicoQuant GmbH, Nov 2007

  Note: This is a console application (i.e. run in terminal window)
  Note v2.0: This is now a multidevice library, new functions for open/close.
}
...
const
  ...
  LIBVERSION='2.2';
  LIB='/usr/local/lib/ph300/phlib.so';  //the only difference from Windows
...
//for routing:
function PH_GetRouterVersion(devidx:integer; model:pchar; version:pchar):integer;  //new in v2.0
  stdcall; external LIB;
function PH_GetRoutingChannels(devidx:integer):integer;
  stdcall; external LIB;
function PH_EnableRouting(devidx:integer; enable:integer):integer;
  stdcall; external LIB;
function PH_SetPHR800Input(devidx:integer; channel:integer; level:integer; edge:integer):integer;  //new in v2.0
  stdcall; external LIB;
function PH_SetPHR800CFD(devidx:integer; channel:integer; dscrlevel:integer; zerocross:integer):integer; //new in v2.0
  stdcall; external LIB;
...
begin
  writeln;
  writeln('PicoHarp 300 PHLib    Routing Demo              PicoQuant GmbH, 2007');
  writeln('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
