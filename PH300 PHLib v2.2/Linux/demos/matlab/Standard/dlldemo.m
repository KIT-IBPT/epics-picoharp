...
% Demo for access to PicoHarp 300 Hardware via PHLIB v 2.2.
% The program performs a measurement based on hardcoded settings.
% The resulting histogram (65536 channels) is stored in an ASCII output file.
%
% Ingo Gregor, Michael Wahl, Nov 2007


% Constants from Phdefin.h

REQLIBVER =  '2.2';     % this is the version this program expects
MAXDEVNUM =      8;
...
fprintf('\nPicoHarp 300 PHlib Demo Application             PicoQuant 2007\n');
